...
export const REFRESH_AGENCY_REALTY = 'REFRESH_AGENCY_REALTY';
export const REFRESH_AGENCY_REALTY_SUCCESS = 'REFRESH_AGENCY_REALTY_SUCCESS';
export const REFRESH_AGENCY_REALTY_FAILURE = 'REFRESH_AGENCY_REALTY_FAILURE';
...
export const refreshAgencyRealtyAction = payload =>
  store.dispatch({
    type: REFRESH_AGENCY_REALTY,
    payload
  });
