...
export const REFRESH_AGENCY_PROJECT = 'REFRESH_AGENCY_PROJECT';
export const REFRESH_AGENCY_PROJECT_SUCCESS = 'REFRESH_AGENCY_PROJECT_SUCCESS';
export const REFRESH_AGENCY_PROJECT_FAILURE = 'REFRESH_AGENCY_PROJECT_FAILURE';
...
export const refreshAgencyProjectAction = payload =>
  store.dispatch({
    type: REFRESH_AGENCY_PROJECT,
    payload
  });
