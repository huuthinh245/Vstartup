...
export const LOAD_MORE_LIST_REALTY = 'LOAD_MORE_LIST_REALTY';
export const LOAD_MORE_LIST_REALTY_SUCCESS = 'LOAD_MORE_LIST_REALTY_SUCCESS';
export const LOAD_MORE_LIST_REALTY_FAILURE = 'LOAD_MORE_LIST_REALTY_FAILURE';
...
export const loadMoreListRealtyAction = payload =>
  store.dispatch({
    type: LOAD_MORE_LIST_REALTY,
    payload
  });
