...
(function(root, factory) {
  ...
  describe('AuthApi', function() {
    ...
    describe('registerSocial', function() {
      it('should call registerSocial successfully', function(done) {
        //uncomment below and update the code to test registerSocial
        //instance.registerSocial(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
