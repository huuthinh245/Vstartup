...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RemsApi.ContactApi();
  });
  ...
  describe('ContactApi', function() {
    describe('listContact', function() {
      it('should call listContact successfully', function(done) {
        //uncomment below and update the code to test listContact
        //instance.listContact(function(error) {
