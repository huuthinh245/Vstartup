...
(function(root, factory) {
  ...
  describe('UserApi', function() {
    describe('forgot', function() {
      it('should call forgot successfully', function(done) {
        //uncomment below and update the code to test forgot
        //instance.forgot(function(error) {
