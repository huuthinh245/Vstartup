...
(function(root, factory) {
  ...
  describe('ListApi', function() {
    describe('city', function() {
      it('should call city successfully', function(done) {
        //uncomment below and update the code to test city
        //instance.city(function(error) {
    ...
    describe('option', function() {
      it('should call option successfully', function(done) {
        //uncomment below and update the code to test option
        //instance.option(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
