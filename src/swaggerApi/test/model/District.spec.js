...
(function(root, factory) {
  ...
  describe('District', function() {
    it('should create an instance of District', function() {
      // uncomment below and update the code to test District
      //var instane = new RemsApi.District();
      //expect(instance).to.be.a(RemsApi.District);
    });
