...
(function(root, factory) {
  ...
  describe('Ward', function() {
    it('should create an instance of Ward', function() {
      // uncomment below and update the code to test Ward
      //var instane = new RemsApi.Ward();
      //expect(instance).to.be.a(RemsApi.Ward);
    });
