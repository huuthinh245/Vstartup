...
(function(root, factory) {
  ...
  describe('ListCity', function() {
    it('should create an instance of ListCity', function() {
      // uncomment below and update the code to test ListCity
      //var instane = new RemsApi.ListCity();
      //expect(instance).to.be.a(RemsApi.ListCity);
    });
